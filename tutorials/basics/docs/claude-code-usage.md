...
| **Bypass permissions** | Claude 自动执行所有任务，不会再请求批准 | 适合高信任度或自动化场景 |

**Bypass permissions模式有安全风险！！！** 开放权限后，类似于Openclaw龙虾！谨慎使用！

<img src="../images/claude-code-usage/cli_mode.png" alt="Claude Code 模式切换" style="max-width:480px;width:100%" />

### CLI 开启 Auto mode / Bypass permissions
CC CLI 快捷命令切换工作模式：

| 说明 | 命令 |
|------|------|
| 启动 Auto mode | `claude --enable-auto-mode` |
| 启动时直接进入Bypass permissions（推荐）  | `claude --dangerously-skip-permissions`或者 `claude --permission-mode bypassPermissions` |
| Bypass permissions加入模式切换循环，但不默认启动 | `claude --allow-dangerously-skip-permissions` |
...
<img src="../images/claude-code-usage/model_cli.png" alt="cli切换模型" style="max-width:480px;width:100%" />
...
<img src="../images/claude-code-usage/compact.png" alt="compact" style="max-width:480px;width:100%" />

**② rename**

<img src="../images/claude-code-usage/rename.png" alt="rename" style="max-width:480px;width:100%" />

**③ resume**

<img src="../images/claude-code-usage/resume.png" alt="resume" style="max-width:480px;width:100%" />

**④ export**

<img src="../images/claude-code-usage/export.png" alt="export" style="max-width:480px;width:100%" />
...
| `/review` | 对当前更改进行代码审查,让 Claude 按照预设的多维度清单（如类型安全、性能、安全） 自动进行代码审查。结果会按严重程度分类：🔴 必须修复、🟡 建议优化 和 🟢 小贴士，方便你分优先级处理|
| `/rewind` | 回滚对话和/或代码更改至之前状态，在空输入框中双击 Esc也会触发rewind回滚 |
| `/init` | 初始化项目 CLAUDE.md 文件，建议在已经完成一部分任务后触发 |

**① review**

<img src="../images/claude-code-usage/review.png" alt="review" style="max-width:480px;width:100%" />

**② rewind，空输入框中双击 Esc也会触发rewind回滚**

<img src="../images/claude-code-usage/rewind.png" alt="rewind" style="max-width:480px;width:100%" />

**③ init**

<img src="../images/claude-code-usage/init.png" alt="init" style="max-width:480px;width:100%" />

| 命令 | 功能 |
|------|------|
| `fork conversation from here` | 从当前对话中分支出一个新会话 |
...
<img src="../images/claude-code-usage/mcp.png" alt="mcp" style="max-width:480px;width:100%" />

**② CLI plugins**

<img src="../images/claude-code-usage/plugin3.png" alt="plugin3" style="max-width:480px;width:100%" />
...
> 选中代码片段，快捷键 `Alt+K` 可快速插入 `@file:行号` 引用。
...
| 文章 | 来源 | 说明 |
|------|------|------|
| [Skills 市场1](https://skills.sh//) | 社区 | 可复用的 Claude Code Skills 分享与安装平台 |
| [Skills 市场2](https://skillsmp.com/zh) | 社区 | 可复用的 Claude Code Skills 分享与安装平台 |
